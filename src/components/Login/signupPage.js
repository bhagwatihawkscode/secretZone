...
const handleSuccess = (msg) =>
  toast.success(msg, {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      try {
        const response = await fetch('http://localhost:4000/api/todo/register', {
          method: 'POST',
  ...
  return (
    ...
    <IconButton  className='back-btn' style={{position:'absolute', top:'5px',left:'8px', color:'#ceb04f'}} onClick={backload}>
                <ArrowBackIcon/>
              </IconButton>
       ...
       />
        ...
        <Link to='/login'  className='setthis'>Have an Account ?Login</Link>
        {/* <Link>Already have an account? <span href="#">Sign in</span></Link> */}
      </form>

        <div className="image-container">

         <img src="https://cdn-lite.ip2location.com/img/sign-up.png" alt='signuppage'/>
